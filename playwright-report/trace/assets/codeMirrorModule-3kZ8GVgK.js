        ...
        (function (C, De) {
          ...
          function lr(e, t, n) {
            ...
            for (var i = 0; i < e.length; ++i) {
              ...
              (o.to == t && (o.from != o.to && n == "before" ? (r = i) : (br = i)), o.from == t && (o.from != o.to && n != "before" ? (r = i) : (br = i)));
            }
            return r ?? br;
          }
          var mi = (function () {
            ...
            return function (u, h) {
              ...
              for (var me = 1, pe = x[0]; me < k - 1; ++me) {
                var Fe = x[me];
                (Fe == "+" && pe == "1" && x[me + 1] == "1" ? (x[me] = "1") : Fe == "," && pe == x[me + 1] && (pe == "1" || pe == "n") && (x[me] = pe), (pe = Fe));
              }
              ...
              for (var nt = 0; nt < k; ++nt)
                if (i.test(x[nt])) {
                  ...
                  for (var Qe = (nt ? x[nt - 1] : v) == "L", Tt = (rt < k ? x[rt] : v) == "L", nn = Qe == Tt ? (Qe ? "L" : "R") : v, xr = nt; xr < rt; ++xr) x[xr] = nn;
                  nt = rt - 1;
                }
          ...
          function Ot(e) {
            ...
            if (t) for (var n = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), r = 0; r < t.length; ++r) oe(n, t[r]) == -1 && n.push(t[r]);
          }
          function Ct(e, t) {
          ...
          function Wn(e) {
            if (Or == null) {
              var t = d("span", "​");
              (J(e, d("span", [t, document.createTextNode("x")])), e.firstChild.offsetHeight != 0 && (Or = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && N < 8)));
            }
...
`,
            ...
            (Je.prototype.column = function () {
              return (
                this.lastColumnPos < this.start &&
                  ((this.lastColumnValue = Le(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
          ...
          function f(e) {
            ...
            for (var t = e.parent, n = oe(t.lines, e), r = t.parent; r; t = r, r = r.parent) for (var i = 0; r.children[i] != t; ++i) n += r.children[i].chunkSize();
            return n + t.first;
          }
          function g(e, t) {
            var n = e.first;
          ...
          function bo(e, t, n, r) {
            ...
            var a = ce(i, t.line),
              ...
              h;
            for (r && (h = []); (r || u.pos < t.ch) && !u.eol(); ) ((u.start = u.pos), (l = ki(o, u, s.state)), r && h.push(new xo(u, l, Gt(i.mode, s.state))));
          ...
          function wo(e, t, n, r, i, o, l) {
            ...
            for (t == "" && ko(yo(n, r.state), o); !h.eol(); ) {
              if ((h.pos > e.options.maxHighlightLength ? ((a = !1), l && bi(e, t, r, h.pos), (h.pos = t.length), (v = null)) : (v = ko(ki(n, h, r.state, k), o)), k)) {
                var x = k[0].name;
                x && (v = "m-" + (v ? x + " " + v : x));
              }
              if (!a || u != v) {
          ...
          function Do(e, t) {
            var n = $t && e.markedSpans,
              r;
            if (n) for (var i = void 0, o = 0; o < n.length; ++o) ((i = n[o]), i.marker.collapsed && (t ? i.from : i.to) == null && (!r || Si(r, i.marker) < 0) && (r = i.marker));
            return r;
          }
          function Mo(e) {
            return Do(e, !0);
          ...
          function Za(e, t) {
            ...
            if (n)
              for (var i = 0; i < n.length; ++i) {
                var o = n[i];
                o.marker.collapsed && (o.from == null || o.from < t) && (o.to == null || o.to > t) && (!r || Si(r, o.marker) < 0) && (r = o.marker);
              }
            return r;
          }
          ...
          ((Hr.prototype.lineNo = function () {
            ...
            Bt(Hr));
          function Va(e, t, n, r) {
            ((e.text = t), e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), e.order != null && (e.order = null), Lo(e), Co(e, n));
            var i = r ? r(e) : 1;
            i != e.height && Ft(e, i);
          }
          function $a(e) {
          ...
          function No(e, t) {
            var n = S("span", null, null, _ ? "padding-right: .1px" : null),
              r = { pre: S("pre", [n], "CodeMirror-line"), content: n, col: 0, pos: 0, cm: e, trailingSpace: !1, splitSpaces: e.getOption("lineWrapping") };
            t.measure = {};
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
              var o = i ? t.rest[i - 1] : t.line,
                l = void 0;
              ((r.pos = 0), (r.addToken = ns), sr(e.display.measure) && (l = We(o, e.doc.direction)) && (r.addToken = os(r.addToken, l)), (r.map = []));
          ...
          function ns(e, t, n, r, i, o, l) {
            if (t) {
              var a = e.splitSpaces ? is(t, e.trailingSpace) : t,
                ...
                u = !1,
                h;
              if (!s.test(t)) ((e.col += t.length), (h = document.createTextNode(a)), e.map.push(e.pos, e.pos + t.length, h), b && N < 9 && (u = !0), (e.pos += t.length));
              else {
                ...
                for (var v = 0; ; ) {
                  ...
                  if (x) {
                    ...
                    (b && N < 9 ? h.appendChild(d("span", [M])) : h.appendChild(M), e.map.push(e.pos, e.pos + x, M), (e.col += x), (e.pos += x));
                  }
                  if (!k) break;
                  v += x + 1;
                  var E = void 0;
                  if (k[0] == "	") {
                    var R = e.cm.options.tabSize,
                      U = R - (e.col % R);
                    ((E = h.appendChild(d("span", et(U), "cm-tab"))), E.setAttribute("role", "presentation"), E.setAttribute("cm-text", "	"), (e.col += U));
                  } else
                    k[0] == "\r" ||
                    k[0] ==
                      `
`
                      ? ((E = h.appendChild(d("span", k[0] == "\r" ? "␍" : "␤", "cm-invalidchar"))), E.setAttribute("cm-text", k[0]), (e.col += 1))
          ...
          function Po(e, t, n) {
            ((this.line = t), (this.rest = Qa(t)), (this.size = this.rest ? f(ge(this.rest)) - n + 1 : 1), (this.node = this.text = null), (this.hidden = cr(e, t)));
          }
          function Gn(e, t, n) {
          ...
          function ds(e, t) {
            ...
            (t.text == t.node && (t.node = r.pre),
              ...
              (t.text = r.pre),
              r.bgClass != t.bgClass || r.textClass != t.textClass ? ((t.bgClass = r.bgClass), (t.textClass = r.textClass), Di(e, t)) : n && (t.text.className = n));
          }
          function Di(e, t) {
          ...
          function Bo(e, t, n, r) {
            ...
            if (e.options.lineNumbers || o) {
              var l = hn(t),
                a = (t.gutter = d("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px"));
              if (
                ...
                for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
                  ...
                  h && a.appendChild(d("div", [h], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[u] + "px; width: " + r.gutterWidth[u] + "px"));
                }
            }
          }
          function hs(e, t, n) {
            t.alignable && (t.alignable = null);
            for (var r = H("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o) ((o = i.nextSibling), r.test(i.className) && t.node.removeChild(i));
            Wo(e, t, n);
          }
          function ps(e, t, n, r) {
            var i = zo(e, t);
            return ((t.text = t.node = i.pre), i.bgClass && (t.bgClass = i.bgClass), i.textClass && (t.textClass = i.textClass), Di(e, t), Bo(e, t, n, r), Wo(e, t, r), t.node);
          }
          function Wo(e, t, n) {
          ...
          function Ro(e, t, n) {
            ...
            if (e.rest) {
              ...
              for (var i = 0; i < e.rest.length; i++) if (f(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
            }
          }
          function ms(e, t) {
            t = qt(t);
          ...
          function Ko(e, t, n) {
            for (var r, i, o, l, a, s, u = 0; u < e.length; u += 3)
              if (
                ...
                if (n == "right" && i == s - a) for (; u < e.length - 3 && e[u + 3] == e[u + 4] && !e[u + 5].insertLeft; ) ((r = e[(u += 3) + 2]), (l = "right"));
                break;
              }
          ...
          function xs(e, t, n, r) {
            ...
            if (o.nodeType == 3) {
              for (var h = 0; h < 4; h++) {
                ...
                if (
                  (b && N < 9 && l == 0 && a == i.coverEnd - i.coverStart ? (u = o.parentNode.getBoundingClientRect()) : (u = ys(w(o, l, a).getClientRects(), r)),
                  u.left || u.right || l == 0)
                )
                  break;
                ((a = l), (l = l - 1), (s = "right"));
            ...
            for (var x = u.top - t.rect.top, M = u.bottom - t.rect.top, E = (x + M) / 2, R = t.view.measure.heights, U = 0; U < R.length - 1 && !(E < R[U]); U++);
            var Q = U ? R[U - 1] : 0,
              G = R[U],
              ee = { left: (s == "right" ? u.right : u.left) - t.rect.left, right: (s == "left" ? u.left : u.right) - t.rect.left, top: Q, bottom: G };
          ...
          function ks(e, t, n, r, i) {
            ...
            if (x) {
              ...
              (!u && (M == s || M == a) && M++, (R = M == 0 ? "after" : M == t.text.length ? "before" : Zt(e, o, M - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before"));
          ...
          function Ls(e, t, n) {
              ...
              return (
                or(wt, ee || 0, me ?? Fe, function (tt, St, ft, nt) {
                  ...
                  if (Tt.top - Qe.top <= 3) {
                    ...
                    var Er, mt, on, ho;
                    (rt
                      ? ((Er = u && nn && gt ? a : Qe.left), (mt = u ? s : Mt(tt, ft, "before")), (on = u ? a : Mt(St, ft, "after")), (ho = u && xr && Jt ? s : Tt.right))
                      : ((Er = u ? Mt(tt, ft, "before") : a), (mt = !u && nn && gt ? s : Qe.right), (on = !u && xr && Jt ? a : Tt.left), (ho = u ? Mt(St, ft, "after") : s)),
                      h(Er, Qe.top, mt - Er, Qe.bottom),
                      Qe.bottom < Tt.top && h(a, Qe.bottom, null, Tt.top),
                      h(on, Tt.top, ho - on, Tt.bottom));
                  }
                  ((!Ke || Qn(Qe, Ke) < 0) && (Ke = Qe), Qn(Tt, Ke) < 0 && (Ke = Tt), (!st || Qn(Qe, st) < 0) && (st = Qe), Qn(Tt, st) < 0 && (st = Tt));
                }),
                { start: Ke, end: st }
              );
            }
            ...
            if (k.line == x.line) v(k.line, k.ch, x.ch);
              ...
              (R && (U.top < Q.top - 2 ? (h(U.right, U.top, null, U.bottom), h(a, Q.top, Q.left, Q.bottom)) : h(U.right, U.top, Q.left - U.right, U.bottom)),
          ...
          function Vn(e) {
            for (
              var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0;
              l < t.view.length;
              l++
            ) {
              var a = t.view[l],
              ...
              if (!a.hidden) {
                ...
                if ((x > 0.005 || x < -0.005) && (i < r && (o -= x), Ft(a.line, u), nl(a.line), a.rest)) for (var M = 0; M < a.rest.length; M++) nl(a.rest[M]);
                if (h > e.display.sizerWidth) {
                  var E = Math.ceil(h / Kr(e.display));
                  E > e.display.maxLineLength && ((e.display.maxLineLength = E), (e.display.maxLine = a.line), (e.display.maxLineChanged = !0));
                }
              }
            }
          ...
          function $n(e, t, n) {
            ...
            if (n && n.ensure) {
              var a = n.ensure.from.line,
                s = n.ensure.to.line;
              a < o ? ((o = a), (l = g(t, er(ce(t, a)) + e.wrapper.clientHeight))) : Math.min(s, t.lastLine()) >= l && ((o = g(t, er(ce(t, s)) - e.wrapper.clientHeight)), (l = s));
            }
          ...
          function Cs(e, t) {
            if (!Ze(e, "scrollCursorIntoView")) {
              ...
              if ((t.top + r.top < 0 ? (i = !0) : t.bottom + r.top > (o.defaultView.innerHeight || o.documentElement.clientHeight) && (i = !1), i != null && !we)) {
                var l = d(
                  "div",
                  "​",
                  null,
          ...
          function Ds(e, t, n, r) {
            ...
            !e.options.lineWrapping &&
              t == n &&
              ((n = t.sticky == "before" ? L(t.line, t.ch + 1, "before") : t), (t = t.ch ? L(t.line, t.sticky == "before" ? t.ch - 1 : t.ch, "after") : t));
            for (var o = 0; o < 5; o++) {
              var l = !1,
                a = jt(e, t),
                s = !n || n == t ? a : jt(e, n);
          ...
          function Cr(e, t, n, r) {
            ((t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth))),
              !((n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r) &&
                ((e.doc.scrollLeft = t), fl(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t)));
          }
          function xn(e) {
            var t = e.display,
          ...
          function sl(e) {
            (e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && Ee(e.display.wrapper, e.display.scrollbars.addClass)),
          ...
          function Ps(e) {
            ...
            (e.updatedDisplay && Vn(t),
              ...
              n.maxLineChanged &&
                ...
                (e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + Yt(t) + t.display.barWidth)),
            ...
            if (!(t.highlightFrontier >= e.display.viewTo)) {
              ...
              (t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                if (r.line >= e.display.viewFrom) {
                  ...
                  for (var v = !l || l.length != o.styles.length || (u != h && (!u || !h || u.bgClass != h.bgClass || u.textClass != h.textClass)), k = 0; !v && k < l.length; ++k)
                    v = l[k] != o.styles[k];
          ...
          function Hs(e) {
            if (
              ...
              (e.activeElt.focus(), !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && m(document.body, e.anchorNode) && m(document.body, e.focusNode))
            ) {
          ...
          function qs(e, t, n, r) {
            ...
            ((this.input = n),
              ...
              (i.lineSpace = S("div", [i.measure, i.lineMeasure, i.selectionDiv, i.cursorDiv, i.lineDiv], null, "position: relative; outline: none")));
          ...
          function pl(e, t) {
            ...
            if ((r && s) || (i && u)) {
              ...
              if (r && !I && !z && o != null) {
                (i && u && yn(e, Math.max(0, a.scrollTop + i * o)), Cr(e, Math.max(0, a.scrollLeft + r * o)), (!i || (i && u)) && ht(t), (l.wheelStartX = null));
                return;
              }
              if (i && o != null) {
                var x = i * o,
          ...
          function yl(e, t) {
            ...
            ((e.doc = t), (t.cm = e), Bi(e), Ji(e), xl(e), (e.options.direction = t.direction), e.options.lineWrapping || Ci(e), (e.options.mode = t.modeOption), bt(e));
          }
          function xl(e) {
            ...
            if (
              (i.lastOp == r ||
                (i.lastOrigin == t.origin &&
                  t.origin &&
                  ((t.origin.charAt(0) == "+" && i.lastModTime > o - (e.cm ? e.cm.options.historyEventDelay : 500)) || t.origin.charAt(0) == "*"))) &&
              (l = Gs(i, i.lastOp == r))
            )
              ((a = ge(l.changes)), Z(t.from, t.to) == 0 && Z(t.from, a.to) == 0 ? (a.to = gr(t)) : l.changes.push(Vi(e, t)));
            else {
              var s = ge(i.done);
              for ((!s || !s.ranges) && ii(e.sel, i.done), l = { changes: [Vi(e, t)], generation: i.generation }, i.done.push(l); i.done.length > i.undoDepth; )
          ...
          function Qs(e, t, n) {
            ...
            return (Ye(e, "beforeSelectionChange", e, r), e.cm && Ye(e.cm, "beforeSelectionChange", e.cm, r), r.ranges != t.ranges ? Kt(e.cm, r.ranges, r.ranges.length - 1) : t);
          }
          function Cl(e, t, n) {
          ...
          function Dl(e, t) {
            t.equals(e.sel) || ((e.sel = t), e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Ot(e.cm)), ot(e, "cursorActivity", e));
          }
          function Ml(e) {
                ...
                if ((a.from == null || (u ? a.from <= t.ch : a.from < t.ch)) && (a.to == null || (h ? a.to >= t.ch : a.to > t.ch))) {
                  ...
                  if (n) {
                    var v = s.find(r < 0 ? 1 : -1),
                      k = void 0;
                    if (((r < 0 ? h : u) && (v = Al(e, v, -r, v && v.line == t.line ? o : null)), v && v.line == t.line && (k = Z(v, n)) && (r < 0 ? k < 0 : k > 0)))
                      return Zr(e, v, t, r, i);
                  }
          ...
          function Qr(e, t, n, r, i) {
            var o;
            (r || (r = n), Z(r, n) < 0 && ((o = [r, n]), (n = o[0]), (r = o[1])), typeof t == "string" && (t = e.splitLines(t)), Jr(e, { from: n, to: r, text: t, origin: i }));
          }
          function Il(e, t, n, r) {
          ...
          function $s(e, t, n, r) {
            ...
            return (
              ...
              Ln(e, t, "widget", function (l) {
                ...
                if ((i.insertAt == null ? a.push(i) : a.splice(Math.min(a.length, Math.max(0, i.insertAt)), 0, i), (i.line = l), o && !cr(e, l))) {
              ...
              !t ||
                ...
                Dt(r, function () {
                  var i = t.line,
                    o = f(t.line),
                    l = Ai(r, o);
                  if ((l && (Uo(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)), (r.curOp.updateMaxLine = !0), !cr(n.doc, i) && n.height != null)) {
                    var a = n.height;
                    n.height = null;
                    var s = pn(n) - a;
                    s && Ft(i, i.height + s);
          ...
          function Vr(e, t, n, r, i) {
            ...
            if (
              ...
              if (Fo(e, t.line, t, n, o) || (t.line != n.line && Fo(e, n.line, t, n, o))) throw new Error("Inserting collapsed marker partially overlapping an existing one");
              ja();
            }
            ...
            if (
              ...
              else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title) for (var h = t.line; h <= n.line; h++) dr(s, h, "text");
              ...
              return (
                this.iter(e.line, t.line + 1, function (o) {
                  ...
                  if (l)
                    for (var a = 0; a < l.length; a++) {
                      var s = l[a];
                      !((s.to != null && i == e.line && e.ch >= s.to) || (s.from == null && i != e.line) || (s.from != null && i == t.line && s.from >= t.ch)) &&
                        (!n || n(s.marker)) &&
            ...
            killLine: function (e) {
              return en(e, function (t) {
                if (t.empty()) {
                  ...
                  return t.head.ch == n && t.head.line < e.lastLine() ? { from: t.head, to: L(t.head.line + 1, 0) } : { from: t.head, to: L(t.head.line, n) };
                  ...
                  if (t[r].empty()) {
                    ...
                    if (o) {
                      if ((i.ch == o.length && (i = new L(i.line, i.ch - 1)), i.ch > 0))
                        ((i = new L(i.line, i.ch + 1)), e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), L(i.line, i.ch - 2), i, "+transpose"));
                      else if (i.line > e.doc.first) {
                        var l = ce(e.doc, i.line - 1).text;
                        l && ((i = new L(i.line, 1)), e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + l.charAt(l.length - 1), L(i.line - 1, l.length - 1), i, "+transpose"));
                      }
                    }
                    n.push(new He(i, i));
                  }
...
`,
          ...
          function Jl(e, t, n, r) {
            var i = pu(e, t, r);
            return (i == "multi" && (e.state.keySeq = t), i == "handled" && ot(e, "keyHandled", e, t, n), (i == "handled" || i == "multi") && (ht(n), _i(e)), !!i);
          }
          function Ql(e, t) {
            var n = Xl(t, !0);
            return n
          ...
          function ea(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField()) && !(tr(t.display, e) || Ze(t, e) || (e.ctrlKey && !e.altKey) || (se && e.metaKey))) {
              var n = e.keyCode,
                r = e.charCode;
              if (z && n == io) {
                ((io = null), ht(e));
          ...
          function Tu(e, t, n, r) {
            ...
            var l,
              ...
              u = s.ranges;
            if (
              (r.addNew && !r.extend ? ((a = o.sel.contains(n)), a > -1 ? (l = u[a]) : (l = new He(n, n))) : ((l = o.sel.primary()), (a = o.sel.primIndex)), r.unit == "rectangle")
            )
            ...
            function k(G) {
              if (Z(v, G) != 0)
                if (((v = G), r.unit == "rectangle")) {
                  ...
                  (ee.length || ee.push(new He(n, n)), pt(o, Kt(e, s.ranges.slice(0, a).concat(ee), a), { origin: "*mouse", scroll: !1 }), e.scrollIntoView(G));
                } else {
                  var St = l,
                    ft = ra(e, G, r.unit),
                    nt = St.anchor,
          ...
          function Ge(e, t) {
            ...
            (Fr(this), _ && t.lineWrapping && getComputedStyle(o.lineDiv).textRendering == "optimizelegibility" && (o.lineDiv.style.textRendering = "auto"));
          }
...
`) &&
            ...
            (t && !a && sa(e, t), Gr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = v), (e.curOp.typing = !0), (e.state.pasteIncoming = e.state.cutIncoming = -1));
          }
          function aa(e, t) {
            ...
            if (!(!e.options.electricChars || !e.options.smartIndent))
              for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                ...
                if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
                  ...
                  } else o.electricInput && o.electricInput.test(ce(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = zn(e, i.head.line, "smart"));
          ...
          function fa() {
            var e = d("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; min-height: 1em; outline: none"),
          ...
          function Eu(e) {
            ...
            ((e.prototype = {
              ...
              setOption: function (r, i) {
                var o = this.options,
                  l = o[r];
                (o[r] == i && r != "mode") || ((o[r] = i), t.hasOwnProperty(r) && lt(this, t[r])(this, i, l), Ye(this, "optionChange", this, r));
              },
              ...
              indentLine: vt(function (r, i, o) {
                (typeof i != "string" && typeof i != "number" && (i == null ? (i = this.options.smartIndent ? "smart" : "prev") : (i = i ? "add" : "subtract")),
                  A(this.doc, r) && zn(this, r, i, o));
              }),
              indentSelection: vt(function (r) {
                for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
                  var a = i[l];
                  if (a.empty()) a.head.line > o && (zn(this, a.head.line, r, !0), (o = a.head.line), l == this.doc.sel.primIndex && Gr(this));
                  else {
                    var s = a.from(),
                      u = a.to(),
                      h = Math.max(o, s.line);
              ...
              cursorCoords: function (r, i) {
                ...
                return (r == null ? (o = l.head) : typeof r == "object" ? (o = Ce(this.doc, r)) : (o = r ? l.from() : l.to()), jt(this, o, i || "page"));
              },
              ...
              addWidget: function (r, i, o, l, a) {
                ...
                if (((i.style.position = "absolute"), i.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(i), s.sizer.appendChild(i), l == "over"))
                  ...
                  ((l == "above" || r.bottom + i.offsetHeight > v) && r.top > i.offsetHeight ? (u = r.top - i.offsetHeight) : r.bottom + i.offsetHeight <= v && (u = r.bottom),
              ...
              moveH: vt(function (r, i) {
                ...
                this.extendSelectionsBy(function (l) {
                  return o.display.shift || o.doc.extend || l.empty() ? fo(o.doc, l.head, r, i, o.options.rtlMoveVisually) : r < 0 ? l.from() : l.to();
                }, Oe);
              }),
              ...
              toggleOverwrite: function (r) {
                (r != null && r == this.state.overwrite) ||
                  ((this.state.overwrite = !this.state.overwrite) ? P(this.display.cursorDiv, "CodeMirror-overwrite") : Ee(this.display.cursorDiv, "CodeMirror-overwrite"),
...
`
          ...
          ((je.prototype.init = function (e) {
            ...
            function l(a) {
              if (!(!o(a) || Ze(r, a))) {
                if (r.somethingSelected()) (hi({ lineWise: !1, text: r.getSelections() }), a.type == "cut" && r.replaceSelection("", null, "cut"));
...
`)));
            ...
            (je.prototype.showPrimarySelection = function () {
              ...
              if (!(o && !o.bad && l && !l.bad && Z(_r(o, l), r) == 0 && Z(xt(o, l), i) == 0)) {
                ...
                (x &&
                  (!I && t.state.focused ? (e.collapse(s.node, s.offset), x.collapsed || (e.removeAllRanges(), e.addRange(x))) : (e.removeAllRanges(), e.addRange(x)),
            ...
            (je.prototype.focus = function () {
              this.cm.options.readOnly != "nocursor" &&
                ((!this.selectionInEditor() || y(xe(this.div)) != this.div) && this.showSelection(this.prepareSelection(), !0), this.div.focus());
            }),
            ...
            (je.prototype.pollContent = function () {
              ...
              if (
                ...
                return !1;
              var o, l, a;
              r.line == t.viewFrom || (o = Lr(e, r.line)) == 0 ? ((l = f(t.view[0].line)), (a = t.view[0].node)) : ((l = f(t.view[o].line)), (a = t.view[o - 1].node.nextSibling));
              var s = Lr(e, i.line),
                u,
                h;
              if ((s == t.view.length - 1 ? ((u = t.viewTo - 1), (h = t.lineDiv.lastChild)) : ((u = f(t.view[s + 1].line) - 1), (h = t.view[s + 1].node.previousSibling)), !a))
                return !1;
              for (var v = e.doc.splitLines(Ou(e, a, h, l, u)), k = Vt(e.doc, L(l, 0), L(u, ce(e.doc, u).text.length)); v.length > 1 && k.length > 1; )
              ...
              for (
                ...
                ++M;
              if (v.length == 1 && k.length == 1 && l == r.line) for (; x && x > r.ch && Q.charCodeAt(Q.length - M - 1) == G.charCodeAt(G.length - M - 1); ) (x--, M++);
            ...
            (je.prototype.onKeyPress = function (e) {
              e.charCode == 0 ||
                this.composing ||
                (e.preventDefault(), this.cm.isReadOnly() || lt(this.cm, so)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
            }),
...
`)),
            ...
            (ve(i, "cut", o),
              ...
              ve(i, "compositionstart", function () {
                ...
                (n.composing && n.composing.range.clear(), (n.composing = { start: l, range: r.markText(l, r.getCursor("to"), { className: "CodeMirror-composing" }) }));
              }),
            ...
            ($e.prototype.poll = function () {
              var e = this,
                ...
                n = this.textarea,
                r = this.prevInput;
              if (this.contextMenuPending || this.resetting || !t.state.focused || (ur(n) && !r && !this.composing) || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
                return !1;
              var i = n.value;
              ...
              function k() {
                if (i.selectionStart != null) {
                  var E = n.somethingSelected(),
                    R = "​" + (E ? i.value : "");
                  ((i.value = "⇚"), (i.value = R), (t.prevInput = E ? "" : "​"), (i.selectionStart = 1), (i.selectionEnd = R.length), (r.selForContextMenu = n.doc.sel));
                }
              }
              function x() {
                if (
              ...
              ((s.save = r),
                ...
                (s.toTextArea = function () {
                  ((s.toTextArea = isNaN),
                    ...
                    (e.style.display = ""),
                    e.form && (dt(e.form, "submit", r), !t.leaveSubmitMethodAlone && typeof e.form.submit == "function" && (e.form.submit = i)));
                }));
            }),
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          C.defineMode("css", function (fe, H) {
            ...
            function Ne(T, B) {
              ...
              if (F === "-") {
                ...
                if (T.match(/^-[\w\\\-]*/)) return (T.eatWhile(/[\w\\\-]/), T.match(/^\s*:/, !1) ? oe("variable-2", "variable-definition") : oe("variable-2", "variable"));
            ...
            return (
              ...
              (Pe.atComponentBlock = function (T, B, F) {
                return T == "}" ? et(T, B, F) : T == "{" ? Re(F) && Oe(F, B, xe ? "block" : "top", !1) : (T == "word" && (be = "error"), F.context.type);
              }),
              (Pe.atBlock_parens = function (T, B, F) {
                return T == ")" ? Re(F) : T == "{" || T == "}" ? et(T, B, F, 2) : Pe.atBlock(T, B, F);
              }),
              (Pe.restricted_atBlock_before = function (T, B, F) {
                return T == "{" ? Oe(F, B, "restricted_atBlock") : T == "word" && F.stateArg == "@counter-style" ? ((be = "variable"), "restricted_atBlock_before") : Ue(T, B, F);
              }),
              ...
              (Pe.at = function (T, B, F) {
                return T == ";" ? Re(F) : T == "{" || T == "}" ? et(T, B, F) : (T == "word" ? (be = "tag") : T == "hash" && (be = "builtin"), "at");
              }),
              ...
              }),
              {
                ...
                token: function (T, B) {
                  ...
                  return (F && typeof F == "object" && ((Le = F[1]), (F = F[0])), (be = F), Le != "comment" && (B.state = Pe[B.state](Le, T, B)), be);
                },
                indent: function (T, B) {
                  var F = T.context,
                    Ie = B && B.charAt(0),
                  ...
                  return (
                    ...
                    F.prev &&
                      (Ie == "}" && (F.type == "block" || F.type == "top" || F.type == "interpolation" || F.type == "restricted_atBlock")
                        ...
                        : ((Ie == ")" && (F.type == "parens" || F.type == "atBlock_parens")) || (Ie == "{" && (F.type == "at" || F.type == "atBlock"))) &&
          ...
          var I = ["domain", "regexp", "url", "url-prefix"],
            ...
            N = De(b),
            _ = ["landscape", "portrait", "none", "coarse", "fine", "on-demand", "hover", "interlace", "progressive", "dark", "light", "standard", "high"],
            ie = De(_),
            O = [
              "align-content",
              "align-items",
            ...
            X = De(z),
            ke = ["font-display", "font-family", "src", "unicode-range", "font-variant", "font-feature-settings", "font-stretch", "font-weight", "font-style"],
            we = De(ke),
          ...
          (C.defineMIME("text/css", {
            ...
            C.defineMIME("text/x-scss", {
              ...
              tokenHooks: {
                "/": function (fe, H) {
                  return fe.eat("/") ? (fe.skipToEnd(), ["comment", "comment"]) : fe.eat("*") ? ((H.tokenize = ze), ze(fe, H)) : ["operator", "operator"];
                },
                ":": function (fe) {
                ...
                "@": function (fe) {
                  return fe.eat("{")
                    ...
                    : fe.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/i, !1)
                      ? !1
                      : (fe.eatWhile(/[\w\\\-]/), fe.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"]);
                },
                "&": function () {
                  return ["atom", "atom"];
                },
          ...
          (C.defineMode("xml", function (K, $) {
            ...
            function q(d, S) {
              ...
              if (m == "&") {
                var y;
                return (
                  d.eat("#") ? (d.eat("x") ? (y = d.eatWhile(/[a-fA-F\d]/) && d.eat(";")) : (y = d.eatWhile(/[\d]/) && d.eat(";"))) : (y = d.eatWhile(/[\w\.\-:]/) && d.eat(";")),
                  y ? "atom" : "error"
                );
            ...
            function z(d, S) {
              ...
              if (w == "<") {
                ...
                return /[\'\"]/.test(w) ? ((S.tokenize = X(w)), (S.stringStartCol = d.column()), S.tokenize(d, S)) : (d.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word");
            }
            function X(d) {
              var S = function (w, m) {
                for (; !w.eol(); )
            ...
            function se(d, S) {
              for (var w; ; ) {
                if (!d.context || ((w = d.context.tagName), !b.contextGrabbers.hasOwnProperty(te(w)) || !b.contextGrabbers[te(w)].hasOwnProperty(te(S)))) return;
                ne(d);
              }
            }
            function Ae(d, S, w) {
            ...
            function ye(d, S, w) {
              return d == "word" ? ((w.tagName = S.current()), (O = "tag"), H) : b.allowMissingTagName && d == "endTag" ? ((O = "tag bracket"), H(d, S, w)) : ((O = "error"), ye);
            }
            function de(d, S, w) {
              if (d == "word") {
                var m = S.current();
            ...
            function H(d, S, w) {
              ...
              if (d == "endTag" || d == "selfcloseTag") {
                ...
                return (
                  ...
                  d == "selfcloseTag" || b.autoSelfClosers.hasOwnProperty(te(m)) ? se(w, m) : (se(w, m), (w.context = new re(w, m, y == w.indented))),
                  Ae
                );
              }
              return ((O = "error"), H);
            ...
            return {
              ...
              token: function (d, S) {
                ...
                return ((w || ie) && w != "comment" && ((O = null), (S.state = S.state(ie || w, d, S)), O && (w = O == "error" ? w + " error" : O)), w);
              },
              indent: function (d, S, w) {
                ...
                if (d.tagName) return b.multilineTagIndentPastTag !== !1 ? d.tagStart + d.tagName.length + 2 : d.tagStart + V * (b.multilineTagIndentFactor || 1);
        ...
        (function (C) {
          ...
          (C.defineMode("javascript", function (De, I) {
            ...
            function re(f, g) {
              ...
              if ((A == "<" && f.match("!--")) || (A == "-" && f.match("->") && !/\S/.test(f.string.slice(0, f.start)))) return (f.skipToEnd(), te("comment", "comment"));
              if (q.test(A))
                return (
            ...
            function Ee(f, g, A, W, L) {
              var Z = f.cc;
              for (D.state = f, D.stream = L, D.marked = null, D.cc = Z, D.style = g, f.lexical.hasOwnProperty("align") || (f.lexical.align = !0); ; ) {
                      ...
                      : f == "debugger"
                        ...
                        : f == "{"
                          ...
                          : f == ";"
                            ? d()
                            : f == "if"
                              ? (D.state.lexical.info == "else" && D.state.cc[D.state.cc.length - 1] == ue && D.state.cc.pop()(), d(j("form"), qe, Le, ue, Or))
                              : f == "function"
                                ? d(Pt)
                                : f == "for"
                                    ...
                                    : f == "variable"
                                      ? _ && g == "declare"
                                        ...
                                        : _ && (g == "module" || g == "enum" || g == "type") && D.stream.match(/^\s*\w/, !1)
                                          ? ((D.marked = "keyword"),
                                            g == "enum" ? d(ce) : g == "type" ? d(_n, Te("operator"), We, Te(";")) : d(j("form"), yt, Te("{"), j("}"), Nt, ue, ue))
                                          : _ && g == "namespace"
            ...
            function Re(f, g, A) {
              ...
              if (f != ";") {
                ...
                if (f == "regexp") return ((D.state.lastType = D.marked = "operator"), D.stream.backUp(D.stream.pos - D.stream.start - 1), d(L));
              }
            }
            function Ue(f, g) {
            ...
            function Se(f, g) {
              ...
              if (f == "variable" || D.style == "keyword") {
                ...
                var A;
                return (_ && D.state.fatArrowAt == D.stream.start && (A = D.stream.match(/^\s*:\s*/, !1)) && (D.state.fatArrowAt = D.stream.pos + A[0].length), d(Be));
              } else {
            ...
            function ar(f, g) {
              return f == "variable" && !D.stream.match(/^\s*:/, !1)
                ? (w(g), d(Wt))
                : (f == "variable" && (D.marked = "property"), f == "spread" ? d(yt) : f == "}" ? J() : f == "[" ? d(oe, Te("]"), Te(":"), ar) : d(Te(":"), yt, Wt));
            }
            function ln() {
              return J(yt, Wt);
            }
            ...
            function _t(f, g) {
              return (g == "@" && d(oe, _t), f == "spread" ? d(_t) : _ && y(g) ? ((D.marked = "keyword"), d(_t)) : _ && f == "this" ? d(or, Wt) : J(yt, or, Wt));
            }
            function xi(f, g) {
            ...
            function Ht(f, g) {
              ...
              if (g == "extends" || g == "implements" || (_ && f == ",")) return (g == "implements" && (D.marked = "keyword"), d(_ ? We : oe, Ht));
              if (f == "{") return d(j("}"), Rt, ue);
            }
            function Rt(f, g) {
              if (f == "async" || (f == "variable" && (g == "static" || g == "get" || g == "set" || (_ && y(g))) && D.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1)))
            ...
            return {
              ...
              token: function (f, g) {
                if ((f.sol() && (g.lexical.hasOwnProperty("align") || (g.lexical.align = !1), (g.indented = f.indentation()), de(f, g)), g.tokenize != se && f.eatSpace()))
                  return null;
                var A = g.tokenize(f, g);
                return ke == "comment" ? A : ((g.lastType = ke == "operator" && (we == "++" || we == "--") ? "incdec" : ke), Ee(g, A, ke, we, f));
              },
              indent: function (f, g) {
                ...
                for (; (W.type == "stat" || W.type == "form") && (A == "}" || ((L = f.cc[f.cc.length - 1]) && (L == Oe || L == Re) && !/^[,\.=+\-*:?[\(]/.test(g))); ) W = W.prev;
          ...
          (C.defineMode(
            ...
            function (ie, O) {
              var q = C.getMode(ie, {
                ...
                X = O && O.tags,
                ke = O && O.scriptTypes;
              if ((N(De, z), X && N(X, z), ke)) for (var we = ke.length - 1; we >= 0; we--) z.script.unshift(["type", ke[we].matches, ke[we].mode]);
              function te(re, ne) {
                var se = q.token(re, ne.htmlState),
                  Ae = /\btag\b/.test(se),
                  ye;
                if (Ae && !/[<>\s\/]/.test(re.current()) && (ye = ne.htmlState.tagName && ne.htmlState.tagName.toLowerCase()) && z.hasOwnProperty(ye)) ne.inTag = ye + " ";
                  ...
                  ((ne.token = function (D, J) {
                    return D.match(H, !1) ? ((J.token = te), (J.localState = J.localMode = null), null) : I(D, Ee, J.localMode.token(D, J.localState));
                  }),
                    (ne.localMode = fe),
              ...
              return {
                ...
                indent: function (re, ne, se) {
                  return !re.localMode || /^\s*<\//.test(ne) ? q.indent(re.htmlState, ne, se) : re.localMode.indent ? re.localMode.indent(re.localState, ne, se) : C.Pass;
                },
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          (C.defineMode("python", function (N, _) {
            for (
              var ie = "error",
                ...
                q = [_.singleOperators, _.doubleOperators, _.doubleDelimiters, _.tripleDelimiters, _.operators || /^([-+*/%\/&|^]=?|[<>=]+|\/\/=?|\*\*=?|!=|[~!@]|\.\.\.)/],
                z = 0;
              z < q.length;
              z++
            )
            ...
            if (te) {
              ...
              ((ke = ke.concat(["nonlocal", "None", "aiter", "anext", "async", "await", "breakpoint", "match", "case"])), (we = we.concat(["ascii", "bytes", "exec", "print"])));
            ...
            function de(S, w, m) {
              ...
              if (S.match(/^[0-9\.]/, !1)) {
                var y = !1;
                if ((S.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (y = !0), S.match(/^[\d_]+\.\d*/) && (y = !0), S.match(/^\.\d+/) && (y = !0), y)) return (S.eat(/J/i), "number");
                var P = !1;
                if (
              ...
              if (S.match(ne)) {
                ...
                return le ? ((w.tokenize = ze(S.current(), w.tokenize)), w.tokenize(S, w)) : ((w.tokenize = fe(S.current(), w.tokenize)), w.tokenize(S, w));
              }
            ...
            function ze(S, w) {
              ...
              function P(p) {
                return function (c, Y) {
                  var xe = de(c, Y, !0);
                  return (xe == "punctuation" && (c.current() == "{" ? (Y.tokenize = P(p + 1)) : c.current() == "}" && (p > 1 ? (Y.tokenize = P(p - 1)) : (Y.tokenize = le))), xe);
                };
              }
              function le(p, c) {
                for (; !p.eol(); )
            ...
            var d = {
              startState: function (S) {
                return { tokenize: ye, scopes: [{ offset: S || 0, type: "py", align: null }], indent: S || 0, lastToken: null, lambda: !1, dedent: 0 };
              },
              token: function (S, w) {
                var m = w.errorToken;
                m && (w.errorToken = !1);
          ...
          C.defineMIME("text/x-cython", {
            name: "python",
            extra_keywords: b("by cdef cimport cpdef ctypedef enum except extern gil include nogil property public readonly struct union DEF IF ELIF ELSE"),
          });
        });
      })()),
    wa.exports
    ...
    La ||
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          function I(m, y, P, le) {
            var p = m.indented;
            return (m.context && m.context.type == "statement" && P != "statement" && (p = m.context.indented), (m.context = new De(p, y, P, le, null, m.context)));
          }
          function K(m) {
          ...
          C.defineMode("clike", function (m, y) {
            ...
            return {
              ...
              token: function (ae, Se) {
                var he = Se.context;
                if ((ae.sol() && (he.align == null && (he.align = !1), (Se.indented = ae.indentation()), (Se.startOfLine = !0)), ae.eatSpace())) return (Ie(ae, Se), null);
                ge = Pe = null;
                ...
                if (
                  (Be == "variable" && (Se.prevToken == "def" || (y.typeFirstDefinitions && $(ae, Se, ae.start) && V(Se.context) && ae.match(/^\s*\(/, !1))) && (Be = "def"),
                  Le.token)
                ) {
                  var Me = Le.token(ae, Se, Be);
                  Me !== void 0 && (Be = Me);
                }
                return (Be == "def" && y.styleDefs === !1 && (Be = "variable"), (Se.startOfLine = !1), (Se.prevToken = Pe ? "def" : Be || ge), Ie(ae, Se), Be);
              },
            ...
            Ee(["text/x-c++src", "text/x-c++hdr"], {
              ...
              hooks: {
                ...
                token: function (m, y, P) {
                  if (P == "variable" && m.peek() == "(" && (y.prevToken == ";" || y.prevToken == null || y.prevToken == "}") && ze(m.current())) return "def";
                },
              },
              namespaceSeparator: "::",
              modeProps: { fold: ["brace", "include"] },
          ...
          Ee("text/x-scala", {
            ...
            hooks: {
              ...
              "=": function (m, y) {
                var P = y.context;
                return P.type == "}" && P.align && m.eat(">") ? ((y.context = new De(P.indented, P.column, P.type, P.info, null, P.prev)), "operator") : !1;
              },
              "/": function (m, y) {
        ...
        (function (C) {
          ...
          (C.defineMode(
            ...
            function (De, I) {
              ...
              function ye(p) {
                if (
                  ((p.linkTitle = !1), (p.linkHref = !1), (p.linkText = !1), (p.em = !1), (p.strong = !1), (p.strikethrough = !1), (p.quote = 0), (p.indentedCode = !1), p.f == ze)
                ) {
                  var c = $;
                  if (!c) {
              ...
              function de(p, c) {
                ...
                var oe = !xe && !ue && !c.prevLine.header && (!Te || !j) && !c.prevLine.fencedCodeEnd,
                  ...
                  qe = null;
                if (c.indentationDiff >= 4 && (j || c.prevLine.fencedCodeEnd || c.prevLine.header || xe)) return (p.skipToEnd(), (c.indentedCode = !0), b.code);
                if (p.eatSpace()) return null;
                if (Y && c.indentation <= Le && (qe = p.match(q)) && qe[1].length <= 6)
                  return ((c.quote = 0), (c.header = qe[1].length), (c.thisLine.header = !0), I.highlightFormatting && (c.formatting = "header"), (c.f = c.inline), H(c));
                if (c.indentation <= Le && p.eat(">")) return ((c.quote = Y ? 1 : c.quote + 1), I.highlightFormatting && (c.formatting = "quote"), p.eatSpace(), H(c));
                if (!Ne && !c.setext && Y && c.indentation <= Le && (qe = p.match(ie))) {
                  ...
                  if (c.setext || ((!oe || !Te) && !c.quote && c.list === !1 && !c.code && !Ne && !we.test(p.string) && (qe = p.lookAhead(1)) && (qe = qe.match(z))))
                    return (
                      c.setext
              ...
              function ze(p, c) {
                ...
                if (!$) {
                  ...
                  ((xe.mode.name == "xml" && xe.state.tagStart === null && !xe.state.context && xe.state.tokenize.isInText) || (c.md_inside && p.current().indexOf(">") > -1)) &&
              ...
              function H(p) {
                  ...
                  for (var Y = 0; Y < p.formatting.length; Y++)
                    (c.push(b.formatting + "-" + p.formatting[Y]),
                      ...
                      p.formatting[Y] === "quote" &&
                        (!I.maxBlockquoteDepth || I.maxBlockquoteDepth >= p.quote ? c.push(b.formatting + "-" + p.formatting[Y] + "-" + p.quote) : c.push("error")));
                }
                ...
                if (
                  ...
                  p.quote &&
                    (c.push(b.quote), !I.maxBlockquoteDepth || I.maxBlockquoteDepth >= p.quote ? c.push(b.quote + "-" + p.quote) : c.push(b.quote + "-" + I.maxBlockquoteDepth)),
                  p.list !== !1)
                ) {
                ...
                return (
                  p.trailingSpaceNewLine ? c.push("trailing-space-new-line") : p.trailingSpace && c.push("trailing-space-" + (p.trailingSpace % 2 ? "a" : "b")),
              ...
              function D(p, c) {
                ...
                if (c.taskList) {
                  ...
                  return (xe ? (c.taskOpen = !0) : (c.taskClosed = !0), I.highlightFormatting && (c.formatting = "task"), (c.taskList = !1), H(c));
                }
                if (((c.taskOpen = !1), (c.taskClosed = !1), c.header && p.match(/^#+$/, !0))) return (I.highlightFormatting && (c.formatting = "header"), H(c));
                var j = p.next();
                if (c.linkTitle) {
                  c.linkTitle = !1;
                  var ue = j;
                ...
                if (j === "!" && p.match(/\[[^\]]*\] ?(?:\(|\[)/, !1)) return ((c.imageMarker = !0), (c.image = !0), I.highlightFormatting && (c.formatting = "image"), H(c));
                ...
                if (j === "[" && !c.image) return ((c.linkText && p.match(/^.*?\]/)) || ((c.linkText = !0), I.highlightFormatting && (c.formatting = "link")), H(c));
                if (j === "]" && c.linkText) {
                ...
                if (j === "*" || j === "_") {
                  ...
                  var Ue = p.peek() || " ",
                    ...
                    T = null;
                  if (
                    (Oe % 2 && (!c.em && et && (j === "*" || !ge || te.test(Re)) ? (Pe = !0) : c.em == j && ge && (j === "*" || !et || te.test(Ue)) && (Pe = !1)),
                    Oe > 1 && (!c.strong && et && (j === "*" || !ge || te.test(Re)) ? (T = !0) : c.strong == j && ge && (j === "*" || !et || te.test(Ue)) && (T = !1)),
                    T != null || Pe != null)
                  ) {
                    (I.highlightFormatting && (c.formatting = Pe == null ? "strong" : T == null ? "em" : "strong em"), Pe === !0 && (c.em = j), T === !0 && (c.strong = j));
                    var oe = H(c);
                ...
                if (I.strikethrough) {
                  if (j === "~" && p.eatWhile(j)) {
                    ...
                    } else if (p.match(/^[^\s]/, !1)) return ((c.strikethrough = !0), I.highlightFormatting && (c.formatting = "strikethrough"), H(c));
                  } else if (j === " " && p.match("~~", !0)) {
                    if (p.peek() === " ") return H(c);
                    p.backUp(2);
                  }
              ...
              function d(p, c) {
                ...
                var Y = p.next();
                return Y === "(" || Y === "["
                  ? ((c.f = c.inline = w(Y === "(" ? ")" : "]")), I.highlightFormatting && (c.formatting = "link-string"), (c.linkHref = !0), H(c))
                  : "error";
              }
              var S = { ")": /^(?:[^\\\(\)]|\\.|\((?:[^\\\(\)]|\\.)*\))*?(?=\))/, "]": /^(?:[^\\\[\]]|\\.|\[(?:[^\\\[\]]|\\.)*\])*?(?=\])/ };
              function w(p) {
              ...
              function m(p, c) {
                return p.match(/^([^\]\\]|\\.)*\]:/, !1) ? ((c.f = y), p.next(), I.highlightFormatting && (c.formatting = "link"), (c.linkText = !0), H(c)) : ne(p, c, D);
              }
              function y(p, c) {
                if (p.match("]:", !0)) {
              ...
              function P(p, c) {
                return p.eatSpace()
                  ? null
                  : (p.match(/^[^\s]+/, !0),
                    p.peek() === void 0 ? (c.linkTitle = !0) : p.match(/^(?:\s+(?:"(?:[^"\\]|\\.)+"|'(?:[^'\\]|\\.)+'|\((?:[^)\\]|\\.)+\)))?/, !0),
                    (c.f = c.inline = D),
                    b.linkHref + " url");
              }
              var le = {
                ...
                innerMode: function (p) {
                  return p.block == ze ? { state: p.htmlState, mode: K } : p.localState ? { state: p.localState, mode: p.localMode } : { state: p, mode: le };
                },
                indent: function (p, c, Y) {
                  return p.block == ze && K.indent ? K.indent(p.htmlState, c, Y) : p.localState && p.localMode.indent ? p.localMode.indent(p.localState, c, Y) : C.Pass;
                },
                blankLine: ye,
                getType: H,
                blockCommentStart: "<!--",
        ...
        (function (C) {
          ...
          C.defineOption("placeholder", "", function (N, _, ie) {
            ...
            if (_ && !O)
              ...
              (N.off("blur", $), N.off("change", V), N.off("swapDoc", V), C.off(N.getInputField(), "compositionupdate", N.state.placeholderCompose), De(N));
          ...
          function I(N) {
            ...
            ((_.style.cssText = "height: 0; overflow: visible"), (_.style.direction = N.getOption("direction")), (_.className = "CodeMirror-placeholder CodeMirror-line-like"));
            var ie = N.getOption("placeholder");
            (typeof ie == "string" && (ie = document.createTextNode(ie)), _.appendChild(ie), N.display.lineSpace.insertBefore(_, N.display.lineSpace.firstChild));
          }
          function K(N) {
            setTimeout(function () {
              var _ = !1;
    ...
    Oa ||
      ...
      (function (Et, zt) {
        (function (C) {
            ...
            (C.simpleMode = function (O, q) {
              ...
              var Ae = {
                ...
                copyState: function (de) {
                  var ze = { state: de.state, pending: de.pending, local: de.local, localState: null, indent: de.indent && de.indent.slice(0) };
              ...
              for (var re = O[X.state], ne = 0; ne < re.length; ne++) {
                ...
                if (Ae) {
                  ...
                  if ((ye && ye.apply && (ye = ye(Ae)), Ae.length > 2 && se.token && typeof se.token != "string")) {
                    for (var de = 2; de < Ae.length; de++) Ae[de] && (X.pending || (X.pending = [])).push({ text: Ae[de], token: se.token[de - 1] });
          ...
          function N(O, q, z, X) {
            var ke;
            if (z.persistent) for (var we = q.persistentStates; we && !ke; we = we.next) (z.spec ? b(z.spec, we.spec) : z.mode == we.mode) && (ke = we);
          ...
          (C.defineMode("yaml", function () {
            ...
            return {
              token: function (K, $) {
                ...
                if (K.match(/^(\{|\}|\[|\])/)) return (V == "{" ? $.inlinePairs++ : V == "}" ? $.inlinePairs-- : V == "[" ? $.inlineList++ : $.inlineList--, "meta");
                ...
                if ($.pairStart) {
                  ...
                  if (($.inlinePairs == 0 && K.match(/^\s*-?[0-9\.\,]+\s?$/)) || ($.inlinePairs > 0 && K.match(/^\s*-?[0-9\.\,]+\s?(?=(,|}))/))) return "number";
