import { r as s, j as e, T as F, D as M, M as E, a as B, W as C, b as U, c as z, d as I } from "./assets/defaultSettingsView-Ds-bson8.js";
const A = ({ className: n, style: o, open: r, width: a, verticalOffset: d, requestClose: u, anchor: h, dataTestId: T, children: y }) => {
  ...
  $ = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx("div", {
          className: "progress",
          children: e.jsx("div", { className: "inner-progress", style: { width: y.total ? (100 * y.done) / y.total + "%" : 0 } }),
        }),
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("div", {
                style: { paddingTop: 20 },
                children: [
                  e.jsxs("div", { children: ["1. Click ", e.jsx("a", { href: p, children: "here" }), " to put your trace into the download shelf"] }),
                  e.jsxs("div", { children: ["2. Go to ", e.jsx("a", { href: "https://trace.playwright.dev", children: "trace.playwright.dev" })] }),
        ...
        n && !r.length && e.jsx("div", { className: "drop-target", children: e.jsx("div", { className: "title", children: "Select test to see the trace" }) }),
        b &&
          e.jsx("div", {
            className: "drop-target",
            onDragLeave: () => {
