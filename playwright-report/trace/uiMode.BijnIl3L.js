...
class ot {
  constructor(t, e = {}) {
    ((this.isListing = !1), (this._tests = new Map()), (this._rootSuite = new Q("", "root")), (this._options = e), (this._reporter = t));
  }
  reset() {
  ...
  _onStepBegin(t, e, s) {
    ...
    const i = this._tests.get(t),
      ...
      l = new te(s, n, g, c);
    (n ? n.steps.push(l) : c.steps.push(l), c._stepMap.set(s.id, l), (a = (_ = this._reporter).onStepBegin) == null || a.call(_, i, c, l));
  }
  _onStepEnd(t, e, s) {
    var g, l;
    const i = this._tests.get(t),
    ...
    ((n._endPayload = s), (n.duration = s.duration), (n.error = s.error), (l = (g = this._reporter).onStepEnd) == null || l.call(g, i, c, n));
  }
  _onAttach(t, e, s) {
    this._tests
      .get(t)
...
class nt {
  constructor(t, e, s, i, c) {
    ...
    const g = (l, _, a) => {
      ...
      for (const h of _.tests) {
        ...
        (this._addChild(u, B), this._treeItemByTestId.set(h.id, B), (u.duration = u.children.reduce((C, T) => C + T.duration, 0)));
      }
    };
  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(" "),
      ...
      g = (l) => {
        const _ = [];
        for (const a of l.children) a.kind === "case" ? n(a) && _.push(a) : (g(a), (a.children.length || a.hasLoadErrors) && _.push(a));
        l.children = _;
      };
    g(this.rootItem);
  }
...
function St(r) {
  ...
  r.kind === "group" && r.children.sort((n, g) => n.location.file.localeCompare(g.location.file) || n.location.line - g.location.line);
  ...
  i ? (r.status = "running") : c ? (r.status = "scheduled") : s ? (r.status = "failed") : e ? (r.status = "skipped") : t && (r.status = "passed");
}
function re(r) {
  const t = new Set(),
    e = (s) => {
      var i;
      s.kind === "case" ? s.tests.map((c) => c.id).forEach((c) => t.add(c)) : s.kind === "test" ? t.add(s.id) : (i = s.children) == null || i.forEach(e);
    };
  return (e(r), t);
}
...
class oe {
  ...
  asModel() {
    return { rootSuite: this.rootSuite || new Q("", "root"), config: this.config, loadErrors: this.loadErrors, progress: this.progress };
  }
}
const ne = ({ source: r }) => {
    const [t, e] = Mt(),
      [s, i] = K.useState(Dt()),
      [c] = K.useState(Ft(() => import("./assets/xtermModule-BoAIEibi.js"), __vite__mapDeps([0, 1]), import.meta.url).then((g) => g.default)),
      n = K.useRef(null);
    return (
      ...
      K.useEffect(() => {
        ...
        return (
          (async () => {
            ...
            const u = new _({ convertEol: !0, fontSize: 13, scrollback: 1e4, fontFamily: "var(--vscode-editor-font-family)", theme: v }),
              b = new a();
            u.loadAddon(b);
  ...
  ce = ({ filterText: r, setFilterText: t, statusFilters: e, setStatusFilters: s, projectFilters: i, setProjectFilters: c, testModel: n, runTests: g }) => {
...
const he = Wt,
  fe = ({
    ...
    d.useEffect(() => {
      ...
      const E = (x) => {
        ...
        (x.children.forEach(E),
          !f &&
            x.status === "failed" &&
            ((x.kind === "test" && c.testIds.has(x.test.id)) || (x.kind === "case" && c.testIds.has((M = x.tests[0]) == null ? void 0 : M.id))) &&
            (f = x));
      };
    ...
    (d.useEffect(() => {
      ...
      const f = pe(R, t);
      let E;
      ((R == null ? void 0 : R.kind) === "test" ? (E = R.test) : (R == null ? void 0 : R.kind) === "case" && R.tests.length === 1 && (E = R.tests[0]),
        ...
        return (
          (_.current = setTimeout(async () => {
            try {
              ...
              const T = new bt([]);
              (T.errorDescriptors.push(...u.errors.flatMap((L) => (L.message ? [{ message: L.message }] : []))), n({ model: T, isLive: !1 }));
            } finally {
              l(g + 1);
            }
          }, 500)),
        ...
        return (
          ...
          (async () => {
            try {
              ...
              const P = await w.listTests({ projects: I.projects, locations: I.args, grep: I.grep, grepInvert: I.grepInvert });
      ...
      const p = w.onTestFilesChanged(async (m) => {
        if (
          ((E.current = E.current.then(async () => {
            L(!0);
            try {
              const D = await w.listTests({ projects: I.projects, locations: I.args, grep: I.grep, grepInvert: I.grepInvert });
        ...
        if (R) {
          const D = (j) => {
            ...
            (W && U.has(W) && P.push(...y.collectTestIds(j)), j.kind === "group" && j.subKind === "folder" && j.children.forEach(D));
          };
          D(y.rootItem);
        } else
      ...
      children: [
        !ct &&
          o.jsxs("dialog", {
            ref: it,
            children: [
              o.jsxs("div", { className: "title", children: [o.jsx("span", { className: "codicon codicon-lightbulb" }), "Install browsers"] }),
              o.jsxs("div", {
                className: "body",
                children: [
        ...
        Tt &&
          o.jsxs("div", {
            ...
            children: [
              ...
              o.jsxs("div", {
                children: [o.jsx("a", { href: "#", onClick: () => (window.location.href = "/"), children: "Reload the page" }), " to reconnect"],
              }),
            ],
          }),
        o.jsx(Yt, {
            ...
            children: [
              ...
              o.jsx("div", {
                ...
                children: o.jsx(me, {
                  ...
                  revealSource: It,
                  onOpenExternally: (p) => (w == null ? void 0 : w.openNoReply({ location: { file: p.file, line: p.line, column: p.column } })),
                }),
              }),
            ],
          }),
                ...
                children: [
                  ...
                  !N &&
                    ...
                    o.jsx("div", {
                      ...
                      children: o.jsxs("div", { children: [v.passed, "/", v.total, " passed (", ((v.passed / v.total) * 100) | 0, "%)"] }),
                    }),
                  N &&
                    v &&
                    o.jsx("div", {
                      ...
                      className: "status-line",
                      children: o.jsxs("div", {
                        children: ["Running ", v.passed, "/", O.testIds.size, " passed (", ((v.passed / O.testIds.size) * 100) | 0, "%)"],
                      }),
                    }),
                  o.jsx(F, { icon: "play", title: "Run all — F5", onClick: () => V("bounce-if-busy", B), disabled: N || T }),
                  o.jsx(F, {
                    icon: "debug-stop",
...
(async () => {
  if ((Xt(), window.location.protocol !== "file:")) {
    if ((window.location.href.includes("isUnderTest=true") && (await new Promise((r) => setTimeout(r, 1e3))), !navigator.serviceWorker))
